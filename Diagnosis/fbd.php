                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6 form-container">
                                ...
                                <div class="form-step welcome-step active" id="welcome">
                                    <h1>Welcome to Our Online Symptom Checker!</h1>
                                    <p>Let's get started with a few easy steps.</p>
                                    <button onclick="startForm()">Get Started</button>
                                </div>

                                <div class="form-step" id="step1">
                                    <h2>Select a Body part for Diagnosis: </h2>
                                    <p>
                                    <form action="php/body_sublocation.php" method="post" id="bodyloc_form">
                                        <?php require 'php/body_loc.php' ?>
                                        <button type="submit" id="submit" onclick="nextStep()">Next</button>
                                    </form>
