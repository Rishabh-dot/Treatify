                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6 form-container">
                                ...
                                <div class="form-step welcome-step active" id="welcome">
                                    <h1>Select the Symptom for specified Body Sublocation:</h1>
                                    <p>
                                    <form action="report.php" method="post" id="bodysubloc_form">
                                        <?php
                                        ...
                                        class Demo
                                        {
                                            ...
                                            public function simulate()
                                            {
                                                ...
                                                $symptoms = $this->diagnosisClient->loadSublocationSymptoms($_POST['bodysubloc'], 'man');
                                                if (count($symptoms) == 0) {
                                                    print "Sit Back and Relax! No serious symptoms for selected body sublocation";
                                                    echo "<br><br><a href='/treatify/index.html'><button type='button'>Go to Home</button></a>";
                                                } else {
                                            ...
                                            private function printSimpleObject($object)
                                            {
                                                ...
                                                array_map(function ($var) {
                                                    echo "<br><input type='radio' name='symptom' id='symptom' value='{$var['ID']}' onclick=\"updateHiddenValue('{$var['Name']}')\"> {$var['Name']}<br>";

                                                }, $object);
                                                echo "<input type='hidden' name='name_of_symptom' id='name_of_symptom'>";
                                                echo "<br><button type='submit' id='submit'>Submit and get report</button>";
                                            }
                                        }
